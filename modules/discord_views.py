...
class CustomSelect(discord.ui.Select):
    def __init__(self, options, placeholder, min_values, max_values, future):
...
class SelectMenu(BaseView):
    def __init__(self, user: discord.User | discord.Member, options: list, placeholder: str, timeout: float = 60.0, min_values: int = 1, max_values: int = 1):
        super().__init__(user=user, timeout=timeout)
        self.future = asyncio.Future()
        self.add_item(CustomSelect(options, placeholder, min_values, max_values, self.future))
